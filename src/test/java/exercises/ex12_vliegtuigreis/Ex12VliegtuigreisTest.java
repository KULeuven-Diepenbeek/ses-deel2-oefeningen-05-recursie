...
public class Ex12VliegtuigreisTest {

    private static final Vliegtuigreis.Item ITEM_50 = new Vliegtuigreis.Item("A", 50, 10);
    private static final Vliegtuigreis.Item ITEM_20 = new Vliegtuigreis.Item("B", 20, 5);
    private static final Vliegtuigreis.Item ITEM_10 = new Vliegtuigreis.Item("C", 10, 2);
    private static final Vliegtuigreis.Item ITEM_5 = new Vliegtuigreis.Item("D", 5, 1);
    ...
    public void multiple_items_not_all_fit() {
        assertThat(Vliegtuigreis.pack(List.of(ITEM_50, ITEM_20, ITEM_10, ITEM_5), 60))
                .hasSize(2)
                .doesNotContain(ITEM_20, ITEM_5);
    }
    ...
    public void multiple_items_not_all_fit2() {
        assertThat(Vliegtuigreis.pack(List.of(ITEM_50, ITEM_20, ITEM_10, ITEM_5), 20))
                .hasSize(1)
                .containsExactlyInAnyOrder(ITEM_20);
    }
}
